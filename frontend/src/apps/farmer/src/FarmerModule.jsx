...
const TRANSLATIONS = {
  en: {
    ...
    loginTitle: 'Farmer Profile & Login',
    loginSub: 'Set up your farm profile to get matched with buyers',
    labels: {
      fullName: 'Full Name',
      phone: 'Mobile Number',
      district: 'District / Place',
      pref: 'Selling Preference',
      prefBulk: 'Bulk Only (100kg+ to Wholesalers/Factories)',
      prefRetail: 'Small Only (1-50kg to Local Consumers)',
      prefBoth: 'Both (Bulk Pooled + Retail Excess)',
      saveProfile: 'Save Profile & Enter Portal'
    },
    nav: {
      dashboard: 'Dashboard',
  ...
  ta: {
    ...
    loginTitle: 'உழவர் பதிவு மற்றும் சுயவிவரம்',
    loginSub: 'சரியான வியாபாரிகளை இணைக்க உங்கள் விவரங்களை பதிவு செய்க',
    labels: {
      ...
      saveProfile: 'சுயவிவரம் சேமித்து உள்ளே செல்க'
    },
    nav: {
      dashboard: 'முகப்பு',
  ...
  hi: {
    ...
    loginTitle: 'किसान प्रोफ़ाइल और लॉगिन',
    loginSub: 'सही खरीदारों से जुड़ने के लिए विवरण दर्ज करें',
    labels: {
      fullName: 'पूरा नाम',
      phone: 'मोबाइल नंबर',
      district: 'जिला / स्थान',
      ...
      saveProfile: 'प्रोफ़ाइल सहेजें और शुरू करें'
    },
    nav: {
      dashboard: 'डैशबोर्ड',
      inventory: 'मेरी उपज',
...
export default function FarmerModule() {
  ...
  // Profile State with Selling Preference
    ...
    <div className="min-h-screen bg-[#F7F6F0] text-slate-900 flex font-sans relative">
        ...
        <div>
          ...
          <nav className="space-y-1">
            {[
              ...
              { id: 'harvest', label: t.nav.harvest, icon: Calendar },
        ...
        <div className="space-y-2">
          ...
          >
            <div>
              ...
              <p className="text-[10px] text-emerald-300 truncate max-w-[130px]">{profile.district}</p>
            </div>
      ...
      <div className="flex-1 flex flex-col h-screen overflow-y-auto">
        ...
        <main className="p-8 space-y-6 max-w-6xl">
          ...
          {notification.show && (
            <div className="bg-emerald-50 border-2 border-emerald-300 rounded-2xl p-4 flex items-center justify-between shadow-sm animate-in fade-in duration-300">
              <div className="flex items-center gap-3">
            ...
            <>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm">
                  ...
                  <h3 className="text-2xl font-black text-[#E89B3C] mt-1">{orders.filter(o => o.status === 'Ready for Pickup').length} Orders</h3>
                ...
                <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm">
                  ...
                  <span className="text-[11px] text-blue-500 font-semibold">Matched with verified buyers</span>
                </div>
              </div>
          ...
          <div className="bg-[#F7F6F0] w-full max-w-lg rounded-3xl overflow-hidden shadow-2xl border border-gray-200">
            <div className="bg-[#1F6B45] text-white p-6 flex justify-between items-start">
              <div>
                ...
                <h3 className="text-lg font-bold mt-1">{t.loginTitle}</h3>
                <p className="text-xs text-emerald-200">{t.loginSub}</p>
              </div>
            ...
            <div className="p-6 space-y-4 bg-white">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {[
                    { id: 'bulk', title: 'Bulk Only (100kg+)', desc: 'Sell entire yield directly to supermarkets and food processors.' },
